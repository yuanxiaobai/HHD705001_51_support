...
#define MIN_ETH_PAYLOAD          20    /*!< Minimum Ethernet payload size */
...
#define ETH_DMATxDesc_LS    ((uint32_t)0x40000000)  /*!< Last Segment */	                        	/*changed*/
#define ETH_DMATxDesc_FS    ((uint32_t)0x20000000)  /*!< First Segment */	                        	/*changed*/
#define ETH_DMATxDesc_CIC   ((uint32_t)0x18000000)  /*!< Checksum Insertion Control: 4 cases */    /*changed*/
...
#define ETH_DMATxDesc_DC    ((uint32_t)0x04000000)  /*!< Disable CRC */                            /*changed*/
#define ETH_DMATxDesc_TER   ((uint32_t)0x02000000)  /*!< Transmit End of Ring */                   /*changed*/
#define ETH_DMATxDesc_TCH   ((uint32_t)0x01000000)  /*!< Second Address Chained */                 /*changed*/
#define ETH_DMATxDesc_DP    ((uint32_t)0x00800000)  /*!< Disable Padding */                        /*changed*/
#define ETH_DMATxDesc_TTSE  ((uint32_t)0x00400000)  /*!< Transmit Time Stamp Enable */             /*changed*/
...
/** @defgroup PHY_Reset_Delay 
  * @{
  */ 
#define PHY_ResetDelay                  ((uint32_t)0x000FFFF) 
...
#define PHY_ConfigDelay                 ((uint32_t)0x0000FFFF)
/**
  * @}
  */
...
/**
	* @brief  For RTL8211E
	*/
//#define PHY_Speed_Status							((u16)0xC000)
//#define PHY_Duplex_Status							((u16)0x2000)
...
/** 
  ...
  */ 
#define IS_ETH_DMATxDESC_BUFFER_SIZE(SIZE) ((SIZE) <= 0x7FF)
...
#define MAC_TXCLK_RTCLK_DIV  0x40021280			//MAC tx rx 时钟分频，[15:8]:rx_clk div,[7:0] tx_clk
												//这两个时钟从系统主频分得，MII 100M
...
int ETH_GetReceivedFrame_IT(ETH_DMARxFrameInfos *state);
