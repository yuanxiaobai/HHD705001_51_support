#ifndef __HHD_RCC_H__
#define __HHD_RCC_H__
#include "hhd32f1xx.h"
...
#define RCC_APB2Periph_GMAC              ((uint32_t)0x00400000)
#define RCC_APB2Periph_SPI4              ((uint32_t)0x00800000)
#define RCC_APB2Periph_SPI5              ((uint32_t)0x01000100)
...
#define IS_RCC_APB1_PERIPH(PERIPH) ((((PERIPH) &    0xE18137C0) == 0x00) && ((PERIPH) != 0x00))
