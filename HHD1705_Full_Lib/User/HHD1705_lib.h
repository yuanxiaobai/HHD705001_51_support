...
#define xMII_MODE           /* MII mode  (走调试网口) */
#define MII_TO_SGMII	   	/* MII to SGMII 功能 (走交换机)*/ 
...
#define CFG_USING_FIND_MARK /* 是否使用Mark发现机制*/
#define xCFG_USING_CLIENT_TEST /* 是否使用 网络客户端测试*/
